<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: validUserName === 'invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model="userName" @blur="validityInput" />
      <p v-if="validUserName === 'invalid'"> Please enter a valid user name </p>
    </div>
